...
def logger(filepath: str, console_debug_level: int=1, file_debug_level: int=0) -> logging.Logger:
...
if __name__ == "__main__":
    logger("/home/mouloud/Documents/projects/data_platform_e-commerce_company/logger.log")
